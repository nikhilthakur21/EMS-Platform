...
const EmployeeDashboard = () => {
    ...
    const loadTasks = () => {
        ...
        const myTasks = allTasks.filter(t => t.empEmail === user.email);
        setTasks(myTasks);
    };
        ...
        <div className="container-fluid py-5 px-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
            <div className="container">
                ...
                <div className="d-flex justify-content-between align-items-center mb-5">
                    <div>
                        <h2 className="fw-bold mb-0 text-dark">Employee <span className="text-primary">Workspace</span></h2>
                        <p className="text-muted">Welcome back, {user?.username}!</p>
                    </div>
                    <button onClick={logout} className="btn btn-outline-secondary btn-sm px-3 rounded-pill">Logout</button>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="card shadow-sm border-0 rounded-4 p-4 text-center mb-4 bg-white">
                            <div className="mx-auto mb-3 d-flex align-items-center justify-content-center bg-primary text-white rounded-circle shadow-sm" style={{ width: '80px', height: '80px', fontSize: '2rem', fontWeight: 'bold' }}>
                        ...
                        <div className="row g-3">
                            <div className="col-6">
                                <div className="card border-0 shadow-sm rounded-4 p-3 bg-white text-center">
                                    ...
                                    <small className="text-muted fw-bold uppercase">Pending</small>
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="card border-0 shadow-sm rounded-4 p-3 bg-white text-center">
                                    <h3 className="fw-bold text-success mb-0">{completedCount}</h3>
                                    <small className="text-muted fw-bold uppercase">Done</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-8">
                        ...
                        {tasks.length > 0 ? tasks.map(t => (
                            ...
                            <div className="text-center py-5 bg-white rounded-4 shadow-sm">
                                <p className="text-muted mb-0">No tasks currently assigned to you. Enjoy your day! ☕</p>
                            </div>
                        )}
                    </div>
                </div>
